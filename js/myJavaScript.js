...
$( document ).ready(function() {
	$("#actionBtn0").click(function(){
		...
		$("#detailStd0").html("Subject : "+std0.position +" <br>Detail: " + std0.office);
...
$( document ).ready(function() {
	$("#actionBtn3").click(function(){
		var std2 = JSON.parse(myDataPublic2);
		$("#nameStd3").text(std3.name);
		$("#detailStd3").html("ตำแหน่ง "+std3.position +" <br>สังกัด " + std3.office);
		$("#imageStd3").attr("src","images/"+std3.image);
	});
